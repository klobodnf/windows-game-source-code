...
if (!(hwnd = CreateWindow(WINDOW_CLASS_NAME, // class
						  "Irregular Shape Collision Demo",	 // title
						  WS_POPUP | WS_VISIBLE,
					 	  0,0,	   // x,y
						  WINDOW_WIDTH,  // width
...
// draw shape
Draw_Polygon2D(&shape, back_buffer, back_lpitch);
...
// draw the title
Draw_Text_GDI("Object to Contour Collision DEMO, Press <ESC> to Exit.",10, 10,RGB(255,255,255), lpddsback);
